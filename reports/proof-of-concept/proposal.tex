...
The match result is in JSON format so we can almost directly store it. However, the replay data is completely unstructured \codeinline{.dem.bz2} binary file,
